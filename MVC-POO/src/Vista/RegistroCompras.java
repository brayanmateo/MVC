...
public class RegistroCompras extends javax.swing.JPanel {
    ...
    public RegistroCompras() {
        ...
        String sql = "SELECT id_compra, total, sub_total, descuento, iva, cantidad, id_producto FROM compra WHERE rut = '" + txtrut + "'"; 
    ...
    private void initComponents() {
        ...
        BIENVENIDOS.setText("COMPRAS POR PROVEEDOR");
        ...
        jLabel1.setText("INGRESE RUT DEL PROVEEDOR:");
